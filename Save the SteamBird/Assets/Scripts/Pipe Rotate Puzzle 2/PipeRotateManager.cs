    ...
    public void PipeWinCheck()
    {
        ...
        if(pipe1Correct && pipe2Correct && pipe3Correct && pipe4Correct && pipe5Correct && pipe6Correct && pipe7Correct && pipe8Correct)
        {
            if(!puzzleComplete)
            {
                ...
                puzzleComplete = true;
                pipe1.puzzleComplete = true;
                pipe2.puzzleComplete = true;
                pipe3.puzzleComplete = true;
                pipe4.puzzleComplete = true;
                pipe5.puzzleComplete = true;
                pipe6.puzzleComplete = true;
                pipe7.puzzleComplete = true;
                pipe8.puzzleComplete = true;
            }
        }
    }
}
